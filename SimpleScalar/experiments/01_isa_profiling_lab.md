...
**Table: Instruction class profile for Alpha benchmark programs**
...
All instruction-class values except total instructions are percentages.

Answer these questions for each benchmark:
1. Is the benchmark memory intensive or computation intensive?
1. Is the benchmark mainly using integer computation or floating-point computation?
1. What percentage of instructions are conditional branches?
1. On average, how many instructions execute between conditional branches?
...
**Table: Instruction class profile for Alpha test programs**
...
**Table: Instruction class profile for PISA test programs**
