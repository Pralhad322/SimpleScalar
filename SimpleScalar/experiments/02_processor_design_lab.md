...
1. What is the final value of `sim_IPC`?
1. Is data forwarding implemented? To answer, examine the pipeline trace for a RAW hazard. Look for a sequence like:
...
1. What is the `sim_IPC` for this configuration?
1. Compare the IPC from Part 1 and Part 2. What does this tell you about the benefit of out-of-order execution for this workload?
1. In an out-of-order processor, the Commit stage ensures results are written back in program order. Why is in-order commit necessary?
